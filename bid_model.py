...
class BidDayOffer(Document):
	...
	BIDOFFERDATE = DateTimeField()
	FIRSTDISPATCH = DateTimeField()
	FIRSTPREDISPATCH = DateTimeField()
	...
	BIDVERSIONNO = IntField()
	MR_FACTOR = StringField()
